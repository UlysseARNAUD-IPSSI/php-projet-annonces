...
if (!isset($title)) $title = $annonce->title;
if (!isset($description)) $description = $annonce->description;
if (!isset($price)) $price = $annonce->price;
if (!isset($ends_at)) $ends_at = (new DateTime($annonce->ends_at))->format('Y-m-d\TH:m');
...
?>
    ...
    <section class="mt-5">
        <div class="container">
            <div class="row">
                <div class="col">
                    <form method="post" action="/admin/annonces/<?= $annonce->id ?>/edit">
